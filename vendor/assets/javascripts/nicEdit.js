...
/// OB: Changed this
	iconsPath : '/assets/nicEditorIcons2.gif',
///
...
var nicEditorAdvancedButton = nicEditorButton.extend({
	...
	addForm : function(f,elm) {
		...
		for(itm in f) {
          ...
          // OB: CHANGED THIS:
		new bkElement('input').setAttributes({'type' : 'submit'}).setStyle({backgroundColor : '#efefef',border : '1px solid #ccc', margin : '3px 30px', 'float' : 'right', 'clear' : 'both'}).appendTo(this.form);
...
// OB: CHANGED STYLE HERE
var nicLinkButton = nicEditorAdvancedButton.extend({	
	addPane : function() {
		this.ln = this.ne.selectedInstance.selElm().parentTag('A');
		this.addForm({
			'' : {type : 'title', txt : 'Add/Edit Link'},
			'href' : {type : 'text', txt : 'URL', value : 'http://', style : {width: '170px'}},
		  'title' : {type : 'text', txt : 'Title', style:{width:'170px',padding:'2px 5[x'}},
// OB: REMOVED THIS:
